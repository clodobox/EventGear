    ...
    <div className="space-y-6">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Taux d&apos;utilisation</dt>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="bg-white shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Rapports Récents</h2>
          <div className="space-y-3">
            {['Inventaire Mensuel - Novembre 2024', 'Rapport d\'utilisation Q3 2024', 'Analyse des coûts - Octobre 2024'].map((report, i) => (
              <div key={i} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center">
                  <FileText className="h-5 w-5 text-gray-400 mr-3" />
                  <span className="text-sm text-gray-900">{report}</span>
                </div>
                <button className="text-indigo-600 hover:text-indigo-900 text-sm">Télécharger</button>
              </div>
            ))}
          </div>
        </div>
